    ...
    <div class="login-stub">
      ...
      <section class="section">
        ...
        <div class="button-group">
          <button @click="navigateToSearch" class="primary-button">学習者検索TOPへ</button>
          <button @click="navigateToReviewList" class="secondary-button">要検討リストへ</button>
        </div>
      </section>
  
      <!-- ログアウトエリア -->
      <section class="section">
        <button @click="navigateToLogout" class="danger-button">ログアウト</button>
      </section>
    </div>
  </template>
